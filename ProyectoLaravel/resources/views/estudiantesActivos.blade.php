...
<body>
	...
	<div class="offcanvas-body">
		<div class="list-group w-100 h-100" id="list-tab" role="tablist">
			...
			<a class="list-group-item list-group-item-dark list-group-item-action" id="list-messages-list" data-bs-toggle="list" href="#list-messages" role="tab" aria-controls="list-messages" ><i class="fas fa-user-graduate"></i> Lista de Estudiantes Activos</a>
    ...
    <div class="container">
        <div class='row'>
            <h3 class="text-center">Estudiantes Activos</h3>
                ...
                <tbody>
                    @foreach ($estudiantes as $estudiante)
                        <tr>
                            ...
                            <td>{{ $estudiante->nom_per }}&nbsp;{{ $estudiante->paterno_per}}&nbsp;{{ $estudiante->materno_per}}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
